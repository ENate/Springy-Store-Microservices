...
public class GatewayConfiguration {
    ...
    /**
     * This method is to check all the services health status, and Gateway service
     * health will be only
     * in up health state if and only if all of the core services and dependencies
     * are up and running.
     *
     * @return ReactiveHealthContributor information about all the core
     *         microservices.
     */
