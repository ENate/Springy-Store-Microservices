...
class IsSameEvent extends TypeSafeMatcher<String> {
    ...
    private final Event<Integer, Product> expectedEvent;

    private IsSameEvent(Event<Integer, Product> expectedEvent) {
        this.expectedEvent = expectedEvent;
    }

    public static Matcher<String> sameEventExceptCreatedAt(Event<Integer, Product> expectedEvent) {
